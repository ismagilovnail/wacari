import defaultLogo from "../../Public/Profile/default-avatar.png";
import "../../Public/Profile/edit.scss";
...
export default function AdminUserEdit({ user, profile, id }) {
    ...
    return (
        <AdminLayout>
            <Typography variant={'h3'}>Редактировать профиль пользователя</Typography>
